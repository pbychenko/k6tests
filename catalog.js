...
const url1 = 'https://api.technodom.kz/katalog/api/v1/products/filters?city_id=5f5f1e3b4c8a49e692fefd70&category=smartfony&sorting=score&price=0';
...
const url2 = 'https://api.technodom.kz/katalog/api/v1/products/category/smartfony?city_id=5f5f1e3b4c8a49e692fefd70&limit=24&sorting=score&price=0';

export const options = {
  stages: [
    { duration: '30s', target: 700 }, // simulate ramp-up of traffic from 1 to 100 users over 5 minutes.
    { duration: '1m', target: 700 }, // stay at 100 users for 10 minutes
